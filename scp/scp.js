/*
	...
	示例下载-标准版：http://yunpan.cn/lk/11m2lilevk
...
function CaptureManager()
{
	var _this = this;
	var mgr = this;
	KE.lang['screencapture'] = "截屏";
	KE.plugin['screencapture'] = {
		click: function(id)
		{
			mgr.Capture();
		}
	...
	this.SetEditorID = function(eid){this.EditorID = eid;};
	...
	this.InsertToEditor = function(src)
	{
		...
		img += src;
		img += '"/>';
		KE.appendHtml(_this.EditorID,img);
	};
}
